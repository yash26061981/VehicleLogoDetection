...
import com.avanseus.avr.model.Point;
...
/**
 * Created by hemanth on 17/5/16.
 */
public class ThinningService {

    public BufferedImage doZhangSuenThinning(BufferedImage inImage) {
        ImageUtils imageUtils = new ImageUtils();
        int[][] binaryImage = imageUtils.get2DImageInteger(inImage);
        ...
        return imageUtils.getBufferedImageFrom2D(binaryImage);
    }
